...
<div class="container mt-4 mb-4 pt-4 pb-4 pr-5 pl-5 rounded-4">
        ...
        <h1 class="page-header text-center">
            <p>Registro para máquina-herramienta</p> 
        </h1>
        ...
        <form action="?c=Persona&a=Guardar" method="POST" enctype="multipart/form-data" id="Registro" class="mt-4">
            <div class="form-group" id="idmahe">
                ...
                <input name="nombre" type="text" class="form-control form-control-lg" id="nombre" placeholder="-- Nombre  del aparato a registrar --">
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select id="mahe_type" class="form-control">
                    <option value="" selected>-- Seleccione el tipo de instrumento--</option>
            ...
            <div class="form-group">
                <label for="date">Fecha de adquisición:</label>
                    <input type="date" name="fecha_adq" class="form-control" placeholder="Ingrese la fecha en la que se adquirió el instrumento" id="start" name="trip-start" value="" min="1980-01-01" max="2019-12-31">
            </div>
            ...
            <div class="form-group">
                <label for="inputState">Condición de uso del aparato:</label>
                    <select name="cond_mant" id="inputState" class="form-control">
                        <option selected>-- Seleccione la condición actual del aparato --</option>
                        <option>Nuevo</option>
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input value="Sin necesidad de mantenimiento" name="cond_uso" type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                    <label class="custom-control-label green" for="customRadio1">Sin necesidad de mantenimiento</label>
                </div>
                <div class="custom-control custom-radio">
                    <input value="Requiere mantenimiento preventivo" name="cond_uso" type="radio" id="customRadio2" name="customRadio" class="custom-control-input">
                    <label class="custom-control-label green" for="customRadio2">Requiere mantenimiento preventivo</label>
                </div>
                <div class="custom-control custom-radio">
                    <input value="Requiere mantenimiento correctivo" name="cond_uso" type="radio" id="customRadio3" name="customRadio" class="custom-control-input">
                    <label class="custom-control-label green" for="customRadio3">Requiere mantenimiento correctivo</label>
                </div>
                <div class="custom-control custom-radio">
                    <input value="Actualmente en mantenimiento" name="cond_uso" type="radio" id="customRadio4" name="customRadio" class="custom-control-input">
                    <label class="custom-control-label green" for="customRadio4">Actualmente en mantenimiento</label>
                </div>
                <div class="custom-control custom-radio">
                    <input value="No puede repararse" name="cond_uso" type="radio" id="customRadio5" name="customRadio" class="custom-control-input">
            ...
            <div class="form-group">
                <label for="date">Fecha de avería registrada:</label>
                    <input name="fecha_falla" type="date" name="fecha de falla" class="form-control" placeholder="Ingrese la fecha en la que falló el instrumento" id="start" name="trip-start" value="" min="1980-01-01" max="2019-12-31">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="desc_falla" class="form-control" id="productDescription" rows="4" placeholder="Describa brevemente la avería del aparato"></textarea>
            </div>
